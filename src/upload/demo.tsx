...
import { CosSdk, imageToWebp, runImgUpload, useImageUploads } from '@rtwc/comm';
...
export default () => {
  const { status, msg, process, upload, runRetry, loading, addFile } = useImageUploads(sdk);
